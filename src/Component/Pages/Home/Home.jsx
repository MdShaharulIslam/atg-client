          ...
          <div className="items-center lg:flex">
            <div className="w-full lg:w-1/2">
              <div className="lg:max-w-lg bg-white bg-opacity-75 p-6 rounded-lg shadow-md">
                ...
                Welcome to  <span className="text-blue-500"> Easysubstech </span>
                </h1>
      ...
      <section className="py-16 bg-white dark:bg-gray-900">
        <div className="container px-6 mx-auto text-center">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white lg:text-3xl">
            Why Choose <span className="text-blue-500">Easysubstech?</span>
          </h2>
          <div className="grid grid-cols-1 gap-6 mt-8 lg:grid-cols-3">
            <div className="p-6 bg-gray-100 rounded-lg shadow dark:bg-gray-800 animate-fade-in-up">
